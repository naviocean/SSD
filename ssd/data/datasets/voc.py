...
class VOCDataset(torch.utils.data.Dataset):
    def __init__(self, data_dir, split, class_names, transform=None, target_transform=None, keep_difficult=False):
        ...
        self.class_names = VOCDataset.get_class_names(class_names)
    ...
    def _read_image(self, image_id):
        image_files = [os.path.join(self.data_dir, "JPEGImages", f"{image_id}{ext}") for ext in [
            '.jpg', '.png', '.jpeg']]
